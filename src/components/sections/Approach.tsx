...
export function Approach() {
  ...
  return (
    <section id="methode" className="py-24 bg-secondary text-foreground overflow-hidden relative border-y border-border">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <p className="text-primary font-bold uppercase tracking-widest text-sm mb-4">Méthode</p>
          ...
          <div className="space-y-12 md:space-y-0">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col md:flex-row items-center">
                ...
                <div className="relative z-10 w-12 h-12 rounded-full bg-primary flex items-center justify-center font-headline font-bold text-primary-foreground shadow-sm shadow-primary/20 shrink-0">
                  {index + 1}
                </div>
